...
const SYSTEM_ROLES = [
  ...
  // CEO/CFO — see server/db.js's cc_approve comment.
  { code: 'CEO', label: 'CEO', icon: 'fa-crown', color: '#eab308',
    internal: true, manageUsers: true, manageRoles: true, accessFM: true,
    decideConflicts: true, authorICMemo: true, riskVeto: false, amlClear: false, ccApprove: true, icSeat: 'GP Rep 1' },
  { code: 'CFO', label: 'CFO', icon: 'fa-coins', color: '#f59e0b',
    internal: true, manageUsers: false, manageRoles: false, accessFM: true,
    decideConflicts: false, authorICMemo: true, riskVeto: false, amlClear: false, ccApprove: true, icSeat: 'GP Rep 2' },
  { code: 'CIO', label: 'CIO', icon: 'fa-chess-king', color: '#0ea5e9',
    internal: true, manageUsers: false, manageRoles: false, accessFM: true,
    decideConflicts: false, authorICMemo: true, riskVeto: false, amlClear: false, ccApprove: false, icSeat: null },
  { code: 'RELATIONSHIP_MANAGER', label: 'RM (Relationship Manager)', icon: 'fa-handshake', color: '#3b82f6',
    ...
    decideConflicts: false, authorICMemo: false, riskVeto: false, amlClear: false, ccApprove: false, icSeat: null },
  ...
  { code: 'COMPLIANCE_OFFICER', label: 'CO (Compliance Officer)', icon: 'fa-shield-alt', color: '#8b5cf6',
    internal: true, manageUsers: false, manageRoles: false, accessFM: true,
    decideConflicts: true, authorICMemo: false, riskVeto: false, amlClear: true, ccApprove: false, icSeat: null },
  ...
  { code: 'RISK_MANAGER', label: 'Risk Manager', icon: 'fa-triangle-exclamation', color: '#dc2626',
    internal: true, manageUsers: false, manageRoles: false, accessFM: true,
    decideConflicts: false, authorICMemo: false, riskVeto: true, amlClear: false, ccApprove: false, icSeat: null },
  { code: 'IC_INDEPENDENT', label: 'Independent Member (IC)', icon: 'fa-user-check', color: '#64748b',
    ...
    decideConflicts: false, authorICMemo: false, riskVeto: false, amlClear: false, ccApprove: false, icSeat: 'Independent Member' },
  { code: 'IC_LP_REP', label: 'LP Representative (IC)', icon: 'fa-user-tie', color: '#64748b',
    internal: false, manageUsers: false, manageRoles: false, accessFM: false,
    decideConflicts: false, authorICMemo: false, riskVeto: false, amlClear: false, ccApprove: false, icSeat: 'LP Rep' },
  ...
  { code: 'AUDITOR', label: 'Внутренний аудитор', icon: 'fa-clipboard-check', color: '#06b6d4',
    internal: true, manageUsers: true, manageRoles: true, accessFM: true,
    decideConflicts: false, authorICMemo: false, riskVeto: false, amlClear: false, ccApprove: false, icSeat: null, readOnly: true },
];
