...
const PERMISSION_DEFS = [
  ...
  { key: 'afsaSubmit', label: 'Подача отчёта регулятору', hint: 'Отметить отчёт отправленным регулятору' },
  { key: 'aiAssist', label: 'AI-ассистент онбординга', hint: 'Черновики DD-заключения, извлечение данных из документов, скрининг — только черновики, без права подписи' },
  { key: 'screeningAccept', label: 'Принятие проектов в скрининг', hint: 'Перевод проекта из Песочницы в Pipeline (стадия «Скрининг»)' },
