...
let cfaClients = [
  {
    id: 1,
    name: 'АО «Костанайский Машиностроительный Завод»',
    ...
    revenue: 3.1,           // $M project fee
    engagementDate: '2025-03-01',
    kycStatus: 'Одобрен',
    amlStatus: 'Пройден',
    pepStatus: 'Нет',
    qualified: true,
    contact: { name: 'Тлеубергенов С.К.', title: 'CFO', email: 's.tleubergenov@kmz.kz', phone: '+7 7142 50 11 22' },
    ubo: [{ name: 'Байтасов Р.М.', share: 62 }],
    description: 'Производитель промышленного оборудования и запчастей для горнодобывающей отрасли. Проект — сопровождение сделки по продаже доли стратегическому инвестору.',
    documents: ['Articles of Association', 'UBO Declaration', 'Audited Financials 2024', 'Source of Funds'],
    notes: 'Сделка закрыта успешно. Клиент на сопровождении.',
    created: '2024-11-05',
    pipeline: [
      { stage: 'Lead', date: '2024-11-05', done: true },
      { stage: 'Qualified', date: '2024-12-10', done: true },
      { stage: 'Proposal', date: '2025-01-15', done: true },
      { stage: 'AML Review', date: '2025-02-05', done: true },
      { stage: 'Active', date: '2025-03-01', done: true },
    ],
    tasks: []
  },
  {
    id: 2,
    name: 'ТОО «Шымкент Текстиль Групп»',
    type: 'Юридическое лицо',
    category: 'SME',
    country: 'Казахстан',
    industry: 'Прочее',
    stage: 'Proposal',
    rmOwner: 'RM (Relationship Manager)',
    services: ['Capital Raising', 'Valuation'],
    revenue: 0.9,
    engagementDate: '2025-11-20',
    kycStatus: 'На проверке',
    amlStatus: 'В процессе',
    pepStatus: 'Нет',
    qualified: true,
    contact: { name: 'Асанова Д.Т.', title: 'Генеральный директор', email: 'd.asanova@shymtex.kz', phone: '+7 725 210 3344' },
    ubo: [{ name: 'Асанова Д.Т.', share: 70 }, { name: 'Ким В.С.', share: 30 }],
    description: 'Производитель и оптовый поставщик текстильной продукции в Южном Казахстане. Ищет $8M на расширение производственных мощностей.',
    documents: ['Registration Certificate', 'Business Plan'],
    notes: 'Ожидается предоставление финансовой отчётности за 2025 год.',
    created: '2025-09-01',
    pipeline: [
      { stage: 'Lead', date: '2025-09-01', done: true },
      { stage: 'Qualified', date: '2025-10-10', done: true },
      { stage: 'Proposal', date: '2025-11-20', done: true },
  ...
  {
    id: 3,
    name: 'ТОО «Алатау Строительный Альянс»',
    type: 'Юридическое лицо',
    category: 'Corporate',
    country: 'Казахстан',
    ...
    services: ['Structuring', 'Due Diligence'],
    revenue: 1.6,
    engagementDate: '2025-12-10',
    kycStatus: 'На подписи',
    amlStatus: 'Enhanced DD',
    pepStatus: 'Требует проверки',
    qualified: false,
    contact: { name: 'Жумабеков А.О.', title: 'Управляющий директор', email: 'a.zhumabekov@alatau-build.kz', phone: '+7 727 355 6070' },
    ubo: [{ name: 'Жумабеков А.О.', share: 45 }, { name: 'Кызылординова М.', share: 35 }, { name: 'Прочие акционеры', share: 20 }],
    description: 'Девелопер жилых и коммерческих комплексов в Алматы. Структурирование сделки по привлечению соинвестора в проект строительства.',
    documents: ['Certificate of Incorporation', 'Register of Directors'],
    notes: '⚠️ Enhanced Due Diligence. Один из акционеров — политически значимое лицо, требуется дополнительная проверка.',
    created: '2025-09-15',
    pipeline: [
      { stage: 'Lead', date: '2025-09-15', done: true },
      { stage: 'Qualified', date: '2025-10-15', done: true },
      { stage: 'Proposal', date: '2025-11-15', done: true },
      { stage: 'AML Review', date: '2025-12-10', done: false },
      { stage: 'Active', date: null, done: false },
    ],
    tasks: []
  },
  {
    id: 4,
    name: 'ИП Оспанов Т.Б. (сеть магазинов «QALA Market»)',
    type: 'ИП',
    category: 'SME',
    country: 'Казахстан',
    industry: 'Ритейл',
    stage: 'Qualified',
    rmOwner: 'RM (Relationship Manager)',
    services: ['Valuation', 'Capital Raising'],
    revenue: 0.4,
    ...
    pepStatus: 'Нет',
    qualified: true,
    contact: { name: 'Оспанов Т.Б.', title: 'Собственник', email: 't.ospanov@qalamarket.kz', phone: '+7 718 220 4455' },
    ubo: [{ name: 'Оспанов Т.Б.', share: 100 }],
    description: 'Розничная сеть продуктовых магазинов в Павлодарской области (14 точек). Рассматривает привлечение капитала для региональной экспансии.',
    documents: [],
    notes: 'Новый клиент. Первичная встреча прошла успешно, готовится due diligence.',
    created: '2025-04-01',
    pipeline: [
      { stage: 'Lead', date: '2025-04-01', done: true },
      { stage: 'Qualified', date: '2025-05-10', done: true },
